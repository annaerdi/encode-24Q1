...
import { ContractAbi } from '../contract-info/certificates';
import QueryMethods from '../query/certificates';
import BuildExtrinsicMethods from '../build-extrinsic/certificates';
import TxSignAndSendMethods from '../tx-sign-and-send/certificates';
import MixedMethods from '../mixed-methods/certificates';
import EventsClass from '../events/certificates';
